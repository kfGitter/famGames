...
<template>
    <AppLayout>
        <div class="space-y-8 p-6">
            ...
            <!-- Streaks -->
            <section class="rounded-xl bg-orange-50 p-4">
            ...
            <section>
                ...
                <ul class="space-y-2">
                    <li v-for="t in topScores" :key="t.game_id" class="flex justify-between rounded-lg bg-white p-3 shadow">
            ...
            <section>
                ...
                <ul v-else class="space-y-2">
                    <li v-for="r in recordsHeld" :key="r.game_title" class="flex justify-between rounded-lg bg-white p-3 shadow">
            ...
            <section>
                ...
                <div v-if="achievements.length === 0" class="text-gray-500">No achievements yet. Keep on playing to unlock more!</div>

                <div class="flex flex-wrap gap-3">
                    <div v-for="a in achievements" :key="a.id" class="rounded-xl bg-yellow-50 p-3 shadow">
